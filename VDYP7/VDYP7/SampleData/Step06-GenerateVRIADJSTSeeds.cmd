...
REM ==========================================================
REM
REM Generates VRIADJST Adjustment Seeds for all polygons not 
...
set V7Report="%~dp0GenerateVRIADJSTSeeds.out"
set V7Error="%~dp0GenerateVRIADJSTSeeds.err"
set V7RunMode=-run
set AddParams=
...
%V7TestMode%%V7Binary% -i %V7DestDB% -o %V7Report% -e %V7Error% -action GenVRIADJSTSeeds %V7RunMode% %AddParams%
