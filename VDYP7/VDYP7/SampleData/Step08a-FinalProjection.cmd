...
REM ==========================================================
REM
REM Projects all polygons not marked as 'IGNORE' to the
REM Final Year of Interest and populates the MDB with the
REM final values.
REM
...
REM     -year   [The Year to Project To]
REM     -run  -norun
REM
...
set V7Report="%~dp0FinalProjection.out"
set V7Error="%~dp0FinalProjection.err"
set V7Year=2020
set V7RunMode=-run
...
%V7TestMode%%V7Binary% -i %V7DestDB% -o %V7Report% -e %V7Error% -action ProjectToFinalYr -year %V7Year% %V7RunMode% %AddParams%
