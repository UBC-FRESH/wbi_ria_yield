...
REM     -srcdb  [Source MDB File(s) to be loaded]
REM     -destdb [Destination MDB file to be combined into]
...
set V7LoadFile="%~dp0MDBConvert.load"
set V7SrcDB="%~dp0OriginalData\66Maps\*.MDB"
set V7Template="%~dp0Template\Template.MDB"
set V7DestDB="%~dp0Combined.MDB"
set V7Report="%~dp0MDBConvert.log"
set V7RunMode=-run
