...
REM ========================================================
REM
REM Load VRIADJST Strata Adjustments from external 
...
REM
REM             If not supplied, defaults to the value: .\LoadVRIADJSTStrata.load
REM
REM     -srcdb  [Access MDB File]
REM             Identifies the Database file holding the VRIADJST Strata.
...
REM
REM             If not supplied, defaults to the table: StrataVRIADJSTAdjustments
REM
...
REM
REM             If not supplied, defaults to the table: VRIADJSTParameterOffsets
REM
...
REM
REM             If not supplied, defaults to the value: .\ResetVRIADJSTStrata.log
REM
...
if "%1" == "-strata" (set V7StrataNames=%2&& shift /1 && goto NextCommandParam)
if "%1" == "/strata" (set V7StrataNames=%2&& shift /1 && goto NextCommandParam)

if "%1" == "-adjst"  (set V7Adjustments=%2&& shift /1 && goto NextCommandParam)
if "%1" == "/adjst"  (set V7Adjustments=%2&& shift /1 && goto NextCommandParam)

if "%1" == "-poly"   (set V7PolyAssignment=%2&& shift /1 && goto NextCommandParam)
if "%1" == "/poly"   (set V7PolyAssignment=%2&& shift /1 && goto NextCommandParam)

if "%1" == "-offset" (set V7PolyOffsets=%2&& shift /1 && goto NextCommandParam)
if "%1" == "/offset" (set V7PolyOffsets=%2&& shift /1 && goto NextCommandParam)
