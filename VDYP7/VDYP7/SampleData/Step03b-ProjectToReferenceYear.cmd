...
REM individual polygon Reference Year.
REM
...
set V7Report="%~dp0ProjectToReferenceYear.out"
set V7Error="%~dp0ProjectToReferenceYear.err"
set V7RunMode=-run
set AddParams=
...
%V7TestMode%%V7Binary% -i %V7DestDB% -o %V7Report% -e %V7Error% -action ProjectRefYr %V7RunMode% %AddParams%
