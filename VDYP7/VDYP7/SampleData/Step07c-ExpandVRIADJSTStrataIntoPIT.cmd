...
REM ========================================================
REM
REM Expands VRIADJST Strata Parameters into the PIT for all
...
REM
REM             If not supplied, defaults to the value: .\ExpandVRIADJSTStrataIntoPIT.load
REM
...
REM
REM             If not supplied, defaults to the value: .\ExpandVRIADJSTStrataIntoPIT.log
REM
...
set V7LoadFile="%~dp0ExpandVRIADJSTStrataIntoPIT.load"
set V7DestDB="%~dp0Combined.mdb"
set V7Report="%~dp0ExpandVRIADJSTStrataIntoPIT.log"
set V7RunMode=-run
